...
EN: dict[str, str] = {
    ...
    "BTN_FAVOURITES_ALL": "🔍 Everything you've bought · with photos",
    "MSG_INLINE_IN_STOCK": "{price} ₴ · in stock",
    "MSG_INLINE_OUT_OF_STOCK": "{price} ₴ · out of stock",
    ...
    "BTN_REORDER": "🛒 Order this again",
    "BTN_REORDER_PARTIAL": "🛒 Order this again · {available} of {total}",
