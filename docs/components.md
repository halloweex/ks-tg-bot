...
**Решения, которые есть в коде и в этом документе, но которых нет в v4** — не
удалены, вынесены сюда, потому что похоже на потерю при сборке v4, а не на
осознанный отказ:

| Решение | Где живёт | Почему важно |
|---|---|---|
