...
> **Читать как исторический снимок.** Собран на `27cd73f`; с тех пор
> изменилось многое, и особенно 2026-08-25 (см. `CHANGELOG.md`). Живые
> документы — `docs/architecture.md` §3, `docs/components.md`,
> `docs/ux-map.md`, `docs/outbox.md`, `docs/move-status.md`. Ценность этого
> файла — в описании того, что было сломано: оно и есть обоснование правил.
